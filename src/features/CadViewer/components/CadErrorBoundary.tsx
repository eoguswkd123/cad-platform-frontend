 ...
 */
export class CadErrorBoundary extends Component<
    CadErrorBoundaryProps,
    CadErrorBoundaryState
> {
    constructor(props: CadErrorBoundaryProps) {
        super(props);
        this.state = { hasError: false, error: null };
    }

    static getDerivedStateFromError(error: Error): CadErrorBoundaryState {
        return { hasError: true, error };
    }

    override componentDidCatch(error: Error, errorInfo: React.ErrorInfo): void {
        // 에러 로깅
        console.error('[CadViewer] Error caught by boundary:', error);
        console.error('[CadViewer] Component stack:', errorInfo.componentStack);
