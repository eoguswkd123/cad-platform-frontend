...
| 2.1.3 HATCH       | 면 채우기 + 렌더링 모드 토글         | ✅ 완료   |
| 2.1.4 Layer Panel | 레이어 표시/숨김 UI, DXF 색상 매핑   | ✅ 완료   |
| 2.1.5 성능 최적화 | Geometry 머징, WebWorker, Basic LOD  | ✅ 완료   |
| 2.1.6 Unit 테스트 | Vitest 단위 테스트 (HATCH 포함 확장) | 🔄 진행중 |
...
├── 2.1.3 엔티티 확장 II (HATCH + 렌더링 모드) ✅ 완료
├── 2.1.4 레이어 기능                          ✅ 완료
├── 2.1.5 성능 최적화                          ✅ 완료
└── 2.1.6 Unit 테스트                          🔄 진행중
```
