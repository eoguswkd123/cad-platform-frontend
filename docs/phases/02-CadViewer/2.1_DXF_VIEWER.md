...
| 2.1.3     | ✅   | HATCH 엔티티 + 렌더링 모드 토글                       |
| 2.1.4     | 📋   | 추가 엔티티 (TEXT, MTEXT, DIMENSION, SPLINE, ELLIPSE) |
| 2.1.5     | ✅   | 레이어별 색상/가시성 토글                             |
| 2.1.6     | ✅   | 성능 최적화 (Geometry 머징, WebWorker, LOD)           |
| 2.1.7     | ✅   | Unit 테스트 (HATCH 포함 확장)                         |
...
| 문서                                                    | 역할               |
| ------------------------------------------------------- | ------------------ |
| [Phase 1.2 Teapot](../01-Foundation/1.2_TEAPOT_DEMO.md) | 컴포넌트 패턴 참조 |
